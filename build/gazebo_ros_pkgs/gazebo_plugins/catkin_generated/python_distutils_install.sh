...
echo_and_run cd "/home/hk/catkin_ws/src/gazebo_ros_pkgs/gazebo_plugins"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/hk/catkin_ws/src/gazebo_ros_pkgs/gazebo_plugins/setup.py" \
     \
    build --build-base "/home/hk/catkin_ws/build/gazebo_ros_pkgs/gazebo_plugins" \
    install \
    --root="${DESTDIR-/}" \
